...
@section('contenido')
    <form action="{{ route('autenticacion.administrativo') }}" method="post">
        @csrf
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-pills nav-center">
                    ...
                    <li role="presentation" class="active"><a href="{{ route('login.administrativo') }}">Personal del Instituto</a></li> 
